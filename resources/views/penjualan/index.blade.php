...
@section('content')
    <h2 style="border-bottom: 4px solid;" class="py-2">
        ...
        <span class="float-right">
            <a href="#" data-target="#modalTotal" data-toggle="modal" class="btn btn-sm btn-primary"><i
                    class="ni ni-chart-pie-35" style="font-size: 1rem;"></i></a>
        </span>
    </h2>
                    ...
                    @foreach ($penjualans as $key => $penjualan)
                        <tr>
                            ...
                            <td class="text-center" style="font-size: 1rem;">
                                <a href="#" data-target="#modalInfo{{ $penjualan->id }}" data-toggle="modal"
                                    class="mr-2">
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="list-group">
                                                        <li class="font-weight-bold list-group-item non-bordered">
                                                            ...
                                                            <br>
                                                            <span
                                                                class="text-muted">{{ $penjualan->jenisSampah->jenis }}</span>
                                                        </li>
                                                        <li class="font-weight-bold list-group-item non-bordered">
                                                            ...
                                                            @if ($penjualan->jenisSampah->harga_pengepul * $penjualan->berat == $penjualan->total_harga)
                                                                <span class="text-muted">Rp.
                                                                    {{ number_format($penjualan->jenisSampah->harga_pengepul) }}</span>
                                                            @else
                                                                <span class="text-danger">
                                                                    Rp.
                                                                    {{ number_format($penjualan->total_harga / $penjualan->berat) }}
                                                                </span>
                                                            @endif
                                                        </li>
                                                        <li class="font-weight-bold list-group-item non-bordered">
                                                        ...
                                                        <li class="font-weight-bold list-group-item non-bordered">
                                                            ...
                                                            <br>
                                                            <span class="text-muted">Rp.
                                                                {{ number_format($penjualan->total_harga) }}</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    {{-- 03-01-2023||Penambahan form tambah --}}
    @if (Auth::user()->role == 2)
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">Jenis Sampah</label>
                                    <input type="text" name="name" id="jenis" class="form-control"
                                        placeholder="Jenis" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">Nama Pengepul</label>
                                    <input type="text" name="name" id="nama_pengepul" class="form-control"
                                        placeholder="Nama Pengepul" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">Harga Satuan</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">Berat</label>
                                    <input type="text" name="name" id="berat" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="telpon" id="telpon" class="form-control"
                                        placeholder="082xxxxxxxxxxxx" required />
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    @if (session()->has('message'))
        <div class="message shadow-sm">
            <div class="alert alert-success alert-dismissible fade show inner-message" role="alert">
                <p style="margin-bottom: 0;"><span class="ni ni-check-bold mr-1"></span> {{ session()->get('message') }}
                </p>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
